...
class DBSimConnector:
    ...
    def parseArguments(self):
        ...
        parser.add_argument("-i", "--input", dest="in_file", required=True,
                type=self.fileMustExist, help="Path to the problem file.",
                metavar="IN_FILE")
        parser.add_argument("-o", "--output", dest="out_file", required=True,
                help="Path to the output file.", metavar="OUT_FILE")
...
if __name__ == "__main__":
    ...
    pcon.phys_con.PhysicsConnector("AFMMarcus", connector.args.in_file,
        connector.args.out_file)
    pcon.setExpectDB(True)
    pcon.readProblem()
    pcon.initCollections()
    connector.dbs = pcon.getSimProps("dbs")
